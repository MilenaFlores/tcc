<div id="navigation" class="span3">
    <a href="#"
       class="visible-phone visible-tablet mainmenu-toggle btn"><i
    ...
    <section id="navigation-section">
        ...
        <div class="menu">
            <nav class="text-center assti span12">
                <h2>Menu<i class="icon-chevron-up visible-phone visible-tablet pull-right"></i></h2>
                <!-- visible-phone visible-tablet -->
                <ul>
                    <li class="item-154 parent"><a href="<?php echo base_url('index.php/cadastro/cadastrodialetivo');?>">Cadastro dia letivo</a></li>

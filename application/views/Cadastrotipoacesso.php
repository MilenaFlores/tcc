                ...
                <div id="content" class="span9">
                    ...
                    <div class="nomecurso">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label  for="nomedocurso" style="padding: 10px">Nome do curso</label>
                                <input type="text" name="nomedocurso" id="nomedocurso" style="width: 380px">
                            </div>
                        </div>
                    </div>
                    <div class="descricaocurso">
                        <div class="form-group">
                            <div class="col-sm-10">
                                <label for="descricaocompleta" style="padding: 10px">Descrição completa</label>
                                <input type="text" name="descricaocompleta" id="descricaocompleta">
                            </div>
                        </div>
                    </div>
                </div>
